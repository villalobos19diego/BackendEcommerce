...
import com.villalobos19.request.CreateProductRequest;
import com.villalobos19.response.ApiResponse;
import com.villalobos19.service.ProductService;
...
public class AdminProductController {
	...
	// Este metodo maneja las  solicitudes  POST a la ruta  "/api/admin/products/"
	@PostMapping("/")
	...
	// Este método maneja las solicitudes DELETE a la ruta "/api/admin/products/{productId}/delete"
	...
	// Este  metodo es para manejar las peticiones   GET a la ruta   "/api/admin/products/all";
	@GetMapping("/all")
	public ResponseEntity<List<Product>> findAllProduct(){
	 ...
	 // Este metodo  es para manejar las peticiones PUT a la ruta  "/api/admin/products/{productId}/update"
